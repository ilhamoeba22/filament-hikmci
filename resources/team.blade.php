    ...
    <div class="row">
        ...
        <div class="team-item rounded border p-4 shadow">
          <div class="row g-0">
            <div class="col-md-4 text-center">
              <img class="img-fluid rounded-circle mb-3" src="{{ asset('frontend/img/MCI_DEDE.png') }}" alt="Team Member">
            </div>
            <div class="col-md-8">
      ...
      <div class="col-lg-6 col-md-12 wow fadeInUp mb-3" data-wow-delay="0.0s">
        <div class="team-item rounded border p-4 shadow">
          <div class="row g-0">
            <div class="col-md-4 text-center">
              <img class="img-fluid rounded-circle mb-3" src="{{ asset('frontend/img/MCI_EDI.png') }}" alt="Team Member">
            </div>
            <div class="col-md-8">
              <div class="h-100 d-flex flex-column justify-content-center px-4">
      ...
      <div class="col-lg-6 col-md-12 wow fadeInUp mb-3" data-wow-delay="0.0s">
        <div class="team-item rounded border p-4 shadow">
          <div class="row g-0">
            <div class="col-md-4 text-center">
              <img class="img-fluid rounded-circle mb-3" src="{{ asset('frontend/img/MCI_AHIM.png') }}" alt="Team Member">
            </div>
            <div class="col-md-8">
              <div class="h-100 d-flex flex-column justify-content-center px-4">
      ...
      <div class="col-lg-6 col-md-12 wow fadeInUp mb-3" data-wow-delay="0.0s">
        <div class="team-item rounded border p-4 shadow">
          <div class="row g-0">
            <div class="col-md-4 text-center">
              <img class="img-fluid rounded-circle mb-3" src="{{ asset('frontend/img/MCI_TOTO.png') }}" alt="Team Member">
            </div>
            <div class="col-md-8">
              <div class="h-100 d-flex flex-column justify-content-center px-4">
      ...
      <div class="col-lg-6 col-md-12 wow fadeInUp mb-3" data-wow-delay="0.0s">
        <div class="team-item rounded border p-4 shadow">
          <div class="row g-0">
            <div class="col-md-4 text-center">
              <img class="img-fluid rounded-circle mb-3" src="{{ asset('frontend/img/MCI_KHOLID.png') }}" alt="Team Member">
            </div>
            <div class="col-md-8">
              <div class="h-100 d-flex flex-column justify-content-center px-4">
      ...
      <div class="col-lg-6 col-md-12 wow fadeInUp mb-3" data-wow-delay="0.0s">
        <div class="team-item rounded border p-4 shadow">
          <div class="row g-0">
            <div class="col-md-4 text-center">
              <img class="img-fluid rounded-circle mb-3" src="{{ asset('frontend/img/MCI_MUSHONIFUL.png') }}" alt="Team Member">
            </div>
            <div class="col-md-8">
              <div class="h-100 d-flex flex-column justify-content-center px-4">
